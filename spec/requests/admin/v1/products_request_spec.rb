  ...
  context "POST /products" do
    ...
    context "with valid params" do
      ...
      it 'adds a new Product' do
        expect do
          post url, headers: auth_header(employee), params: product_params
    ...
    context "with invalid params" do
      ...
      it 'does not add a new Product' do
        expect do
          post url, headers: auth_header(employee), params: product_invalid_params
  ...
  context "PATCH /products/:id" do
    ...
    context "with valid params" do
      ...
      it 'updates product' do
        patch url, headers: auth_header(employee), params: product_params
        product.reload
    ...
    context "with invalid params" do
      ...
      it 'does not update product' do
        ...
        patch url, headers: auth_header(employee), params: product_invalid_params
        product.reload
